  ...
  return (
    <DashboardLayout>
      <div className="p-8 space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-[#f3f2f1] mb-2 tracking-tight">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {/* Total Monitors */}
          <div className="bg-[#1a1b1e] border border-[#27272a] rounded-xl p-6 hover:border-slate-700 transition-colors">
            ...
            <div className="flex items-baseline gap-2">
              <p className="text-3xl font-bold text-[#f3f2f1] tabular-nums">{monitors.length}</p>
              <span className="text-sm text-slate-500">/ {monitorLimit}</span>
            </div>
          </div>

          {/* UP */}
          <div className="bg-[#1a1b1e] border border-[#27272a] rounded-xl p-6 hover:border-green-900/50 transition-colors">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-3xl font-bold text-green-500 tabular-nums">{upMonitors.length}</p>
          </div>

          {/* DOWN */}
          <div className="bg-[#1a1b1e] border border-[#27272a] rounded-xl p-6 hover:border-red-900/50 transition-colors">
            <div className="flex items-center justify-between mb-4">
              ...
              {downMonitors.length > 0 && (
                <span className="text-xs font-medium text-red-500 bg-red-500/10 px-2.5 py-1 rounded-full animate-pulse">
                  ALERTA
                </span>
              )}
            </div>
            <p className="text-sm text-slate-400 mb-1">Inativos</p>
            <p className="text-3xl font-bold text-red-500 tabular-nums">{downMonitors.length}</p>
          </div>

          {/* Uptime */}
          <div className="bg-[#1a1b1e] border border-[#27272a] rounded-xl p-6 hover:border-primary/50 transition-colors">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-baseline gap-1">
              <p className="text-3xl font-bold text-primary tabular-nums">{uptimePercentage}</p>
        ...
        {!canAddMonitor && (
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-6">
            <div className="flex items-start gap-4">
              <div className="p-2.5 bg-yellow-500/10 rounded-lg flex-shrink-0">
        ...
        {/* Monitors Section */}
        <div className="bg-[#1a1b1e] border border-[#27272a] rounded-xl overflow-hidden">
          ...
          <div className="p-6">
            {monitors.length === 0 ? (
              <div className="text-center py-16">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-[#27272a] rounded-xl mb-4">
